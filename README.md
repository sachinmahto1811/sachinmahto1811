...
**Data Analyst | SQL, Python, Power BI, Advanced Excel | Automation & Operational Analytics | NOC Engineer – Telecom Infrastructure**
...
- **SQL:** Joins, CTEs, Subqueries, Window Functions, Aggregations, CASE, Date Functions
- **Python:** Pandas, NumPy, OpenPyXL, Data Cleaning, Automation
- **BI & Visualization:** Power BI, Power Query, Data Visualization
- **Excel:** Advanced Excel, Reporting Automation, Data Transformation
- **Analytics:** EDA, KPI Analysis, Ageing Analysis, RCA-oriented Analysis
- **Tools:** Git, GitHub, Outlook Automation
...
- Data cleaning and master-data mapping
- Business-rule implementation
- Ageing and RCA-oriented processing
- Automated operational summaries and dashboards
